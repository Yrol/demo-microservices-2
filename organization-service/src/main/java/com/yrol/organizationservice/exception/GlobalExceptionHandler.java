...
public class GlobalExceptionHandler  extends ResponseEntityExceptionHandler {
    ...
    // Returning organization already exist exception
    @ExceptionHandler(OrganizationAlreadyExistsException.class)
    public ResponseEntity<ErrorDetails> handleResourceNotFoundException(OrganizationAlreadyExistsException exception, WebRequest webRequest) {
